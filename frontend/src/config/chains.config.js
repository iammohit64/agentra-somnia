...
import { monadTestnet, polkadotTestnet, somniaTestnet } from './custom-chains'
import deployments from '../deployments.json'

// 1. Export the array for Wagmi to initialize
// (Added polkadotTestnet here!)
export const SUPPORTED_CHAINS = [baseSepolia, arbitrumSepolia, monadTestnet, polkadotTestnet, somniaTestnet]
